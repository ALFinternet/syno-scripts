...
SCRIPT_PATH=/volume1/syno-scripts
BACKUP_FILES=true # change to false to disable backups
BACKUP_DIR=$SCRIPT_PATH/backups
...
#sed -i -e 's/80/$HTTP_PORT/' -e 's/443/$HTTPS_PORT/' /usr/syno/share/nginx/server.mustache /usr/syno/share/nginx/DSM.mustache /usr/syno/share/nginx/WWWService.mustache
